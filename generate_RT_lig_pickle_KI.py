...
RT_bc_file = "/users/ikejr8/ikegami/computing_resources/executables/sci-RNA-seq3_pipeline-master/script_folder/3lvl_mRNA_RT_plate_1_bc.txt"
lig_bc_file = "/users/ikejr8/ikegami/computing_resources/executables/sci-RNA-seq3_pipeline-master/script_folder/3lvl_mRNA_Lig_plate_1_bc.txt"

print("This is RT_bc_file", RT_bc_file)
print("This is lig_bc_file", lig_bc_file)
...
pickle_out = open("/users/ikejr8/ikegami/computing_resources/executables/sci-RNA-seq3_pipeline-master/script_folder/3lvl_mRNA_RT_plate_1_bc.pickle","wb")
...
pickle_out = open("/users/ikejr8/ikegami/computing_resources/executables/sci-RNA-seq3_pipeline-master/script_folder/3lvl_mRNA_Lig_plate_1_bc.pickle","wb")
pickle.dump(all_seq_dic, pickle_out)
pickle_out.close()
...
pickle_in = open("/users/ikejr8/ikegami/computing_resources/executables/sci-RNA-seq3_pipeline-master/script_folder/3lvl_mRNA_Lig_plate_1_bc.pickle", "rb")
...
pickle_out = open("/users/ikejr8/ikegami/computing_resources/executables/sci-RNA-seq3_pipeline-master/script_folder/3lvl_mRNA_Lig_plate_1_bc.pickle2", "wb")
...
pickle_in = open("/users/ikejr8/ikegami/computing_resources/executables/sci-RNA-seq3_pipeline-master/script_folder/3lvl_mRNA_RT_plate_1_bc.pickle", "rb")
...
pickle_out = open("/users/ikejr8/ikegami/computing_resources/executables/sci-RNA-seq3_pipeline-master/script_folder/3lvl_mRNA_RT_plate_1_bc.pickle2", "wb")
